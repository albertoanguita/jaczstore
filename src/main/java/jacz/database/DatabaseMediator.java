...
public class DatabaseMediator {
    ...
    public enum ItemType {
        ...
        MOVIE("movies", Movie.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.LANGUAGE, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE, Field.ORIGINAL_TITLE,
                Field.YEAR, Field.SYNOPSIS, Field.SYNOPSIS_LOCALIZED_LANGUAGE, Field.CREATOR_LIST, Field.ACTOR_LIST, Field.COMPANY_LIST, Field.COUNTRIES,
                Field.URIS, Field.GENRES, Field.VIDEO_FILE_LIST, Field.IMAGE_HASH, Field.MINUTES),
        TV_SERIES("tv_series", TVSeries.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.LANGUAGE, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE,
                Field.ORIGINAL_TITLE, Field.YEAR, Field.SYNOPSIS, Field.SYNOPSIS_LOCALIZED_LANGUAGE, Field.CREATOR_LIST, Field.ACTOR_LIST, Field.COMPANY_LIST,
                Field.COUNTRIES, Field.URIS, Field.GENRES, Field.IMAGE_HASH, Field.CHAPTER_LIST),
        CHAPTER("chapters", Chapter.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.LANGUAGE, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE,
                Field.ORIGINAL_TITLE, Field.YEAR, Field.SYNOPSIS, Field.SYNOPSIS_LOCALIZED_LANGUAGE, Field.CREATOR_LIST, Field.ACTOR_LIST,
        ...
        VIDEO_FILE("video_files", VideoFile.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.HASH,
                Field.LENGTH, Field.NAME, Field.ADDITIONAL_SOURCES, Field.MINUTES, Field.RESOLUTION, Field.BITRATE,
    ...
    public enum Field {
        ...
        BITRATE("bitrate", DBType.INTEGER),
        QUALITY_CODE("quality_code", DBType.QUALITY),
        LANGUAGE("language", DBType.LANGUAGE),
        TITLE_LOCALIZED_LANGUAGE("titleLocalizedlanguage", DBType.LOCALIZED_LANGUAGE),
        SYNOPSIS_LOCALIZED_LANGUAGE("synopsisLocalizedlanguage", DBType.LOCALIZED_LANGUAGE),
