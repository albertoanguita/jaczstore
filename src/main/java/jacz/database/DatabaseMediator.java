...
public class DatabaseMediator {
    ...
    public enum ItemType {
        ...
        MOVIE("movies", Movie.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE, Field.ORIGINAL_TITLE,
        ...
        TV_SERIES("tv_series", TVSeries.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE,
        ...
        CHAPTER("chapters", Chapter.class, Field.ID, Field.CREATION_DATE, Field.TIMESTAMP, Field.TITLE, Field.TITLE_LOCALIZED_LANGUAGE,
